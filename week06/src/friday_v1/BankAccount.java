...
public class BankAccount {
	/*This class contains the following information about a bank account:
	 * -Owner's name
	 * -Owner's surname
	 * -Account balance
	 * -Account interest
	...
	private enum InterestType {
		//enumeration matching string to interest type 
	...
	public void printAccountInformation(PrintStream output) throws IOException {
		...
		output.println("Last Name:" + this.mLastName);
		output.println("Age:" + this.mAge);
		output.println("Balance:" + this.mBalance);
		output.println("Interest:" + this.mInterest);
		output.println("InterestType:" + this.mInterestType);
		output.println("History:");
		output.println(getHistory());
	}
